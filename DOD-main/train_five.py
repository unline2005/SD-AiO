...
from DOD.osediff import OSEDiff_reg, OSEDiff_gen
...
def main(args):
    ...
    neg_prompt_embeds = neg_prompt_embeds.expand(10, -1, -1)   
    prompt_embeds = load_neg_prompt_embeds(load_path="prompt_embeds.pt")
    prompt_embeds = prompt_embeds.expand(10, -1, -1) 
    ...
    dataset = PairedSROnlineTxtDataset(
            split='train',
            batch_task_ratios={'dehazing': 4, 'deraining': 2, 'denoising': 2, 'lowlight': 1, 'debluring': 1}
            )
